...
public class PersonalityChart extends Chart {

	public PersonalityChart() {
		super(ChartType.BAR);

		setCaption("Personality");
        getConfiguration().setTitle("");

        XAxis x = new XAxis();
        x.setCategories("Openness", "Conscientiousness", "Introversion/Extraversion", "Agreeableness",   
				"Emotional range");
	...
	public void buildData(String value) {
		...
		ListSeries line1 = helper.getPersonality(value);
